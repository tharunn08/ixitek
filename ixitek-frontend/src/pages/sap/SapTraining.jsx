        ...
        <div className="container-page">
          <div className="flex flex-col items-center gap-5 rounded-2xl border border-teal-100 bg-teal-50/60 px-6 py-12 text-center sm:px-12">
            ...
            <h2 className="max-w-lg text-balance font-display text-2xl font-bold text-ink-900">
              Not sure which module fits your background?
            </h2>
            <p className="max-w-md text-sm leading-relaxed text-ink-600">
              Browse all 25 SAP modules we teach, or book a free career guidance call and we'll recommend a path.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <Button to="/sap/modules" variant="teal" icon="ArrowRight">
                Browse modules
              </Button>
              <Link
                to="/sap/contact?interest=training"
                className="focus-ring inline-flex items-center gap-2 rounded-full border border-ink-200 bg-white px-5 py-3 text-sm font-semibold text-ink-700 transition-colors hover:border-teal-300 hover:text-teal-700"
              >

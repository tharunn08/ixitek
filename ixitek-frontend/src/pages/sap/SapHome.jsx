  ...
  return (
    <>
      ...
      <section className="bg-noise relative overflow-hidden bg-gradient-to-br from-ink-950 via-[#0b2b2a] to-ink-950">
        ...
        <div className="container-page relative grid grid-cols-1 items-center gap-8 py-9 sm:py-11 lg:grid-cols-2 lg:gap-10 lg:py-10">
          <div className="flex flex-col gap-4">
            ...
            <motion.h1
              ...
              animate="show"
              custom={1}
              className="text-balance font-display text-3xl font-extrabold leading-[1.12] text-white sm:text-4xl lg:text-[2.5rem]"
            >
              {sapHero.headline}
            </motion.h1>
            ...
            <motion.p
              ...
              animate="show"
              custom={2}
              className="max-w-lg text-balance text-sm leading-relaxed text-ink-300 sm:text-base"
            >
              {sapHero.subheadline}
            </motion.p>

            <motion.div variants={fadeUp} initial="hidden" animate="show" custom={3} className="flex flex-wrap items-center gap-3 pt-1">
            ...
            <motion.div
              ...
              animate="show"
              custom={4}
              className="mt-1 grid grid-cols-2 gap-4 border-t border-white/10 pt-4 sm:grid-cols-4"
            >
              {sapTrustStats.map((s) => (
                <div key={s.id} className="flex flex-col gap-1">
                  <span className="font-display text-xl font-extrabold text-white sm:text-2xl lg:text-3xl">
          ...
          >
            <div className="w-full max-w-[260px] sm:max-w-[320px] lg:max-w-[300px] xl:max-w-[360px]">
              <SapHeroArt />
            </div>
          </motion.div>
        </div>

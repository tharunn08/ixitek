...
const variants = {
  ...
  // Teal variant — used by the SAP / ERP micro-site as its accent action
  // color (additive; every existing call site keeps using the variants above).
  teal: "bg-teal-600 text-white hover:bg-teal-700 shadow-[0_1px_2px_rgba(13,148,136,0.12)] hover:shadow-[0_10px_24px_-6px_rgba(13,148,136,0.45)]",
};

  ...
  return (
    <div className="border-t border-ink-100 bg-ink-50/60">
      <div className="container-page flex flex-col gap-6 py-10">
        ...
        <div className="flex items-start gap-2.5 rounded-xl border border-dashed border-ink-200 bg-white/70 p-4">
          <Icon name="Info" className="mt-0.5 h-4 w-4 shrink-0 text-ink-400" />
          <p className="text-xs leading-relaxed text-ink-500">{sapDisclaimer}</p>
        </div>
      </div>
    </div>
  );

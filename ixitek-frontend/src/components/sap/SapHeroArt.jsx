      ...
      <div className="relative flex w-full flex-col gap-4">
        {LAYERS.map((layer, i) => (
          <motion.div
            ...
            className={`flex w-fit max-w-full items-center gap-3 rounded-2xl border border-white/15 bg-white/[0.06] px-5 py-3.5 backdrop-blur-sm ${
          ...
          >
            ...
            <span className="whitespace-nowrap text-sm font-semibold text-white">{layer.label}</span>
          </motion.div>
        ))}
      </div>

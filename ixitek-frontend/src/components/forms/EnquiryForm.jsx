...
export default function EnquiryForm({ presetSubject = "", compact = false }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSubmitError(err?.message || "Could not submit your enquiry. Please try again.");
      setStatus("idle");
    }
  }
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      ...
      <p className="text-center text-xs text-ink-400">
        Your enquiry is saved securely to our database and your team is notified by email.
      </p>
    </form>
  );
}

      ...
      <div className="container-page grid grid-cols-1 gap-12 py-16 lg:grid-cols-[1.2fr_0.85fr_0.85fr_1.5fr]">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 pt-1">
            ...
            <a
              href={`https://wa.me/${ADMIN_CONFIG.whatsappNumber}?text=${encodeURIComponent(
                "Hi Ixitek team, I'd like to enquire about your products/services."
              )}`}
              target="_blank"
              rel="noreferrer"
              className="focus-ring flex h-9 w-9 items-center justify-center rounded-md border border-white/10 text-ink-300 transition-colors hover:border-emerald-400 hover:text-white"

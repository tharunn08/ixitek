      ...
      <div className="container-page relative grid grid-cols-1 items-center gap-8 py-9 sm:py-11 lg:grid-cols-2 lg:gap-10 lg:py-10">
        <div className="flex flex-col gap-4">
          ...
          <motion.h1
            ...
            animate="show"
            custom={1}
            className="text-balance font-display text-3xl font-extrabold leading-[1.1] text-white sm:text-4xl lg:text-[2.75rem]"
          >
        ...
        >
          <div className="w-full max-w-[300px] sm:max-w-[360px] lg:max-w-[340px] xl:max-w-[400px]">
            <HeroNetworkArt />
          </div>
        </motion.div>
      </div>
